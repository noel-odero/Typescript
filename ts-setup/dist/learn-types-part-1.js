...
greetMe('Noel');
const candies = ['chocolate', 'lollipop', 'gummy bear'];
...
const nickName = "Brad";
const uppercasedNN = nickName.toUpperCase();
const uppercasedNN1 = nickName.toUpperCase();
// null or undefined
const testStr = 'hello';
const greetings = [
    { name: "Oye" },
